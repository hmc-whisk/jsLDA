                ...
                displayElement={
                    <div style={this.helpTextStyle}>
                        <div style={{margin: "15px"}}>
                            ...
                            <p>
                                A stopword is any word you would like to exclude from your model. During training and
                                ...
                                therefore don't tell you as much about any individual topic. Another important
                                consideration is whether or not a word is relevant to what you are trying to analyze
                                with your topic model. For example, if gender is important to your analysis, you'll want
                                to keep pronouns in the model. If you are not looking at gender, you can consider adding
                ...
                displayElement={
                    <div style={this.helpTextStyle}>
                        <div style={{margin: "15px"}}>
                            ...
                            <p>
                                This is the most basic of the analysis tools and a good place to start. On the left of
                                the page you will see a list of all your topics. Both the number associated with that
                                topic and the words most common to that topic can be found here. The most common words
                                can give you an initial idea of the theme that topic is latching on to. If the most
                            ...
                            <p>
                                The meaning of words in isolation can be hard to discern, so it is necessary to look at
                                them in context before making any conclusions about a topic. The topic document tab is
                            ...
                            <p>
                                ...
                                the same documents more or less often than they would at random. This is calculated by
                                two topic’s pointwise mutual information scores. Blue circles mean they occur together
                                more than we would expect, and red means they occur together less than we would expect.
